...
export default function Navbar() {
    return (
        <main className="flex justify-center">
            <nav className=" z-50 flex fixed justify-between lg:w-[40%] w-[80%] backdrop-filter-[40px] mt-10 lg:h-[6vh]  backdrop-blur items-center rounded-full bg-slate-600 bg-opacity-35 p-2">
